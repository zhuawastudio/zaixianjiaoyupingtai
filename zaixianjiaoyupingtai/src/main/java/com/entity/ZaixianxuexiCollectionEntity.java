...
public class ZaixianxuexiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZaixianxuexiCollectionEntity() {

	}

	public ZaixianxuexiCollectionEntity(T t) {
		try {
