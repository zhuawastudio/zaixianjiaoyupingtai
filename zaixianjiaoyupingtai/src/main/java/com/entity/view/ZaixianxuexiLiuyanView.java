...
public class ZaixianxuexiLiuyanView extends ZaixianxuexiLiuyanEntity implements Serializable {
	...
	public ZaixianxuexiLiuyanView() {

	}

	public ZaixianxuexiLiuyanView(ZaixianxuexiLiuyanEntity zaixianxuexiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, zaixianxuexiLiuyanEntity);
