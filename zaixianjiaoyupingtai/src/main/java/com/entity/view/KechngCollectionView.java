 ...
 * @date 2021-04-15
 */
@TableName("kechng_collection")
public class KechngCollectionView extends KechngCollectionEntity implements Serializable {
	...
	public KechngCollectionView() {

	}

	public KechngCollectionView(KechngCollectionEntity kechngCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, kechngCollectionEntity);
